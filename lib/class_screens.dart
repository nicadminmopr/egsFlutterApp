import 'package:egs/student_name_screen.dart';
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Tapped on Class $className')),
                      );
                    },
                    child: Container(
...
void main() {
  runApp(
    MaterialApp(home: ClassGridScreen(), debugShowCheckedModeBanner: false),
  );
}
